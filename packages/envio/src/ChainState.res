...
let getNextQuery = (cs: t, ~chainTargetItems: float, ~maxTargetBlock=?, ~isRealtime=false) => {
  ...
  cs.fetchState->FetchState.getNextQuery(~chainTargetBlock, ~chainTargetItems, ~isRealtime)
}
