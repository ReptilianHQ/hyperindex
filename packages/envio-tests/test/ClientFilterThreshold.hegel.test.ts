...
describe("client-filter threshold properties (fork-specific)", () => {
    ...
    () => hegel.test((tc) => {
      ...
      fetchState.optimizedPartitions = {
        ...
        entities: {
          ...
          [gapId]: {
            id: gapId,
            latestFetchedBlock: gapFrontier,
            ...
            mutPendingQueries: [{
              ...
              fetchedBlock: pendingFromBlock + retainedSpan - 1,
            }],
      ...
      const entities = Object.fromEntries(ids.map((id, index) => {
        ...
        return [id, {
          ...
          mutPendingQueries: isGap ? [{
            ...
            itemsTarget: undefined,
            itemsEst: 100,
            fetchedBlock: pendingFromBlock + 99,
          }] : [],
      ...
      const gapEntities = Object.fromEntries(gapIds.map((id, index) => {
        ...
        return [id, {
          ...
          mutPendingQueries: [{
            ...
            itemsTarget: undefined,
            itemsEst: gapItems,
            fetchedBlock: pendingFromBlock + gapItems - 1,
          }],
  ...
  test(
    ...
    // Registers threshold-many addresses per case through the debug addon.
    240_000,
  );
