...
// Query provenance is validated separately (SourceManager_test, RateLimit_test,
// the threshold properties); structural fixtures carry this value on both
// sides so `query` can normalize it out.
